...
Now all of your _"rock star"_ design needs are just a mainline npm speedball away. Just make sure your terminal has the latest version of Bootstrap installed and supports 4k textures. Quick, now `rm -rf` all that shit and install **xclip**; that's all it requires.
